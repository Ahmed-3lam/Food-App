...
class DetailsDeliveryAddToCartDialog extends StatefulWidget {
  const DetailsDeliveryAddToCartDialog({
    Key? key,
  ...
  @override
  State<DetailsDeliveryAddToCartDialog> createState() =>
      _DetailsDeliveryAddToCartDialogState();
}

class _DetailsDeliveryAddToCartDialogState
    extends State<DetailsDeliveryAddToCartDialog> {
  int count = 0;
